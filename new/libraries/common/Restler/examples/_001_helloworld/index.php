...
require_once  'pbr-lib-common/src/Restler/vendor/restler.php';
...
$r = new Restler();
//$r = new Restler(true);
//в продакшн режиме вылезает NOTICE, который необходимо блочить error_reporting(0); пока нечяно что это
